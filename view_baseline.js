...
//**disabled**advanced_expl_div = $('<div id="permdialog_advanced_explantion_text">For special permissions or advanced settings, click Advanced.</div>')
...
perm_add_user_select = define_new_user_select_field('perm_add_user', 'Add Users', on_user_change = function(selected_user){
    // console.log("add...")
...
perm_remove_user_button  = $('<button id="perm_remove_user" class="ui-button ui-widget ui-corner-all">Remove Users</button>')
